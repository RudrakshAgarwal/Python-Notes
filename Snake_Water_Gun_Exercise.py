...
This is a two-player game where each player chooses one object.  As we know, there are three objects, snake, water,
and gun. So, the result will be
...
Now moving on to instructions:
    1) You have to use a random choice function that we studied, to select between, snake, water, and gun.
    2) You do not have to use a print statement in case of the above function.
    3) Then you have to give input from your side.
    4) After getting ten consecutive inputs, the computer will show the result based on each iteration.
    5) You have to use loops(while loop is preferred).
'''
